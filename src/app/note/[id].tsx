...
export default function NoteDetailScreen() {
  ...
  const { notes, updateNote, deleteNote, togglePin, toggleFavorite } =
    useNotes();
          ...
          <View style={styles.headerActions}>
            ...
            >
              <Ionicons
                ...
                size={20}
                color={note.isFavorite ? "#EE4540" : "#FFFFFF"}
              />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.headerBtn}
            ...
            >
              <Ionicons
                ...
                size={20}
                color={note.isPinned ? accentColor : "#FFFFFF"}
              />
            </TouchableOpacity>
            {isEditing ? (
              <TouchableOpacity
        ...
        {showOptions && (
          <View style={styles.optionsDropdown}>
            ...
            >
              ...
              <Text style={[styles.optionText, { color: "#EE4540" }]}>
                Eliminar nota
              </Text>
            </TouchableOpacity>
          </View>
